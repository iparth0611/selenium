...
driver.find_element_by_name("first_name").send_keys("Parth")
driver.find_element_by_name("last_name").send_keys("Shah")
driver.find_element_by_name("username").send_keys("iparth0611")
